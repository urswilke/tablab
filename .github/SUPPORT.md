# Getting help with dcmisc

Thanks for using dcmisc. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/dcmisc/issues) to make sure the 
